                            ...
                            <form method="get" action="">
                                <table id="ProductDetailtable" class="table table-bordered table-striped"
                                    ...
                                    <thead>
                                        ...
                                        <h1 style="font-size:140%;">หนังสือส่งตัวนิสิต</h1>
                                        <br></br>
                                        <br></br>
                                            ...
                                            <thead>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="ชื่อ-สกุล"
                                                        aria-label="ชื่อ-สกุล" aria-describedby="basic-addon2">
                                ...
                                <div class="row">
                                    <input type="text" lass="custom-control-input" id="approve" name="ArrApprove"
                                        style="display: none;" />
                                    <input type="text" lass="custom-control-input" id="disapprove" name="ArrDisApprove"
                                        style="display: none;" />
